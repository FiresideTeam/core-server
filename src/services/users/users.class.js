...
exports.Users = class Users extends Service {
  ...
  create(data, params) {
    ...
    //The complete user as given to sequelize, sequleize will add a createdAt and updatedAt property automatically.
    //Thanks sequelize :)
    const userData = {
      ...
      email,
      password,
      //array of UUIDV4 repping room ids, room ids should be generated in the client that initiates the chat and then will be added to the arrays of the other ccounts
      rooms
    }
